...
const PROJECTS = [
  {
    ...
    metrics: ["Absolute Quantity Analysis", "Penetration Analysis", "Data Storytelling", "Dashboarding"],
    color: "#00E5A0",
  },

  {
    ...
    metrics: ["Feature Engineering", "Market Job Insights", "LightGBM Regression"],
    color: "#FF6B6B",
  },
  ...
  },
  {
    ...
    metrics: ["Data Cleaning", "Regression Analysis", "Feature Scaling", "Categorical Encoding", "Linear Regression"],
    color: "#FFB547",
  },
...
const SKILLS = [
  { category: "Languages & Libraries", items: ["Python", "SQL", "Pandas", "NumPy", "Matplotlib", "Seaborn", "Scikit-Learn"] },
  { category: "Data Processing Tools", items: ["Google Colab", "Jupyter Notebook", "Visual Studio Code", "Spreadsheet", "Excel"] },
  { category: "Data Visualization", items: ["Looker", "Tableau", "Power BI"] },
  { category: "Data Science Techniques", items: ["Exploratory Data Analysis", "Data Preprocessing", "Feature Engineering", "Machine Learning", "Regression Analysis"] },
  { category: "Supporting Skills", items: ["AI Prompt Engineering", "Project Management"] },
];
...
const EXPERIENCES = [
  {
    ...
    tags: ["Critical Thinking", "Cross-Functional Synchronization", "Effective Communication", "Leadership", "Operational Excellence", "Problem Solving & Adaptability", "Project Management", "Strategic Planning"],
  },
  {
    ...
    tags: ["Administrative Governance", "Critical Thinking", "Cross-Functional Synchronization", "Effective Communication", "Leadership", "Problem Solving & Adaptability", "Project Management"],
  },
  {
    ...
    tags: ["Critical Thinking", "Cross-Functional Synchronization", "Effective Communication", "Leadership", "Problem Solving & Adaptability", "Project Management"],
  },
];
    ...
    <nav style={{
      ...
      <div style={{
        ...
        <span style={{
          ...
          {/* Cursor berkedip  */}
          <span style={{ 
            width: 2, height: 20, background: "#00E5A0", marginLeft: 2,
    ...
    <section id="home" style={{
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 780 }}>
        ...
        <div style={{
          ...
          {[["5", "Projects"], ["2", "Years Exp."], ["3", "Orgs."]].map(([num, label]) => (
            <div key={label} style={{ textAlign: "center" }}>
              <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 32, fontWeight: 800, color: "#fff" }}>{num}</div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72, alignItems: "center" }}>
        <FadeIn>
          <div>
            ...
            <p style={{ color: "rgba(255,255,255,0.55)", fontSize: 16, lineHeight: 1.8, margin: "0 0 18px", fontFamily: "'DM Sans', sans-serif" }}>
              As an Information Systems student, I have a deep focus on Data & Business Analytics and Machine Learning. I have executed various data-driven projects, ranging from large-scale analysis for the education sector to AI job market prediction models. I combine this technical expertise with project management experience at GDGoC UIN Jakarta, where I managed technology programs for hundreds of community members.
            </p>
            <button
              onClick={() => document.getElementById("contact")?.scrollIntoView({ behavior: "smooth" })}
              style={{
        ...
        <FadeIn delay={0.15}>
          <div style={{
            ...
            {[
              ["🎓", "Education", "Information Systems, UIN Syarif Hidayatullah Jakarta — 2024–Present"],
              ["💼", "Focus Area", "Data & Business Analytics, Predictive Modeling, Business Intelligence"],
              ["🌍", "Location", "Depok, West Java, Indonesia"],
              ["⚡", "Currently", "Looking for remote/hybrid internship opportunities & freelance analytics projects."],
            ].map(([icon, label, val]) => (
              <div key={label} style={{
...
export default function Portfolio() {
  ...
  link2.href = "https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;700&family=DM+Mono&display=swap";
